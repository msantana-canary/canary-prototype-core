...
export const mockCampaigns: ScheduledCampaign[] = [
  {
    ...
    channels: [
      ...
      },
      {
        channel: 'whatsapp',
        isEnabled: false,
        body: 'Hi {{guest_first_name}}! As a Diamond Elite member, you\'re invited to our exclusive Social Hour this Tuesday at 6 PM in the Sky Lounge. Complimentary wine & hors d\'oeuvres. We hope to see you there!',
        language: 'en',
      },
      {
        channel: 'booking',
        isEnabled: false,
        body: 'Dear {{guest_first_name}}, as a valued guest you\'re invited to our Diamond Social Hour this Tuesday at 6:00 PM in the Sky Lounge. Enjoy complimentary wine and hors d\'oeuvres.',
        language: 'en',
      },
      {
        channel: 'expedia',
    ...
    channels: [
      {
        ...
        body: 'Dear {{guest_first_name}}, You\'re invited to an exclusive wine tasting experience at {{hotel_name}}. Join our sommelier in the Grand Cellar for a curated selection of regional wines paired with artisanal cheeses and charcuterie. Space is limited to 20 guests, so reserve your spot today. We look forward to raising a glass with you.',
        language: 'en',
      },
      {
        channel: 'sms',
