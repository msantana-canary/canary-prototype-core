...
export const builtInGroupGuests: Record<string, BroadcastGuestEntry[]> = {
  'group-arrivals': [
    { guestId: 'guest-gel', reservationId: 'res-gel-mar', segment: 'expecting', loyaltyTier: 'non-member', rateCode: 'BAR', room: '101', stayNights: 2, isReturningGuest: false },
    { guestId: 'guest-jack', reservationId: 'res-jack-mar', segment: 'expecting', loyaltyTier: 'non-member', rateCode: 'CORP', groupCode: 'GROUP2026', room: '215', stayNights: 3, isReturningGuest: false },
    ...
    { guestId: 'guest-nook', reservationId: 'res-nook-mar', segment: 'checked-in', loyaltyTier: 'non-member', rateCode: 'CORP', groupCode: 'GROUP2026', room: '208', stayNights: 4, isReturningGuest: true },
    { guestId: 'guest-sofia', reservationId: 'res-sofia-mar', segment: 'expecting', loyaltyTier: 'gold-elite', rateCode: 'RACK', room: '312', stayNights: 2, isReturningGuest: true },
    { guestId: 'guest-carlos', reservationId: 'res-carlos-mar', segment: 'expecting', loyaltyTier: 'non-member', rateCode: 'BAR', room: '103', stayNights: 1, isReturningGuest: false },
    { guestId: 'guest-david-w', reservationId: 'res-david-w-mar', segment: 'expecting', loyaltyTier: 'non-member', rateCode: 'CORP', groupCode: 'CONF2026', room: '205', stayNights: 3, isReturningGuest: false },
    { guestId: 'guest-nina', reservationId: 'res-nina-mar', segment: 'expecting', loyaltyTier: 'gold-elite', rateCode: 'CORP', room: '306', stayNights: 5, isReturningGuest: true },
    { guestId: 'guest-grace', reservationId: 'res-grace-mar', segment: 'expecting', loyaltyTier: 'non-member', rateCode: 'AAA', room: '110', stayNights: 1, isReturningGuest: false },
    { guestId: 'guest-mei', reservationId: 'res-mei-mar', segment: 'expecting', loyaltyTier: 'gold-elite', rateCode: 'CORP', groupCode: 'GROUP2026', room: '407', stayNights: 4, isReturningGuest: true },
    { guestId: 'guest-tariq', reservationId: 'res-tariq-mar', segment: 'expecting', loyaltyTier: 'non-member', rateCode: 'RACK', room: '212', stayNights: 1, isReturningGuest: false },
    { guestId: 'guest-elena', reservationId: 'res-elena-mar', segment: 'expecting', loyaltyTier: 'club-member', rateCode: 'BAR', room: '314', stayNights: 2, isReturningGuest: true },
    { guestId: 'guest-astrid', reservationId: 'res-astrid-mar', segment: 'expecting', loyaltyTier: 'non-member', rateCode: 'BAR', room: '107', stayNights: 1, isReturningGuest: false },
  ],
  'group-in-house': [
    ...
    { guestId: 'guest-lucia', reservationId: 'res-lucia-mar', loyaltyTier: 'silver-elite', rateCode: 'AAA', room: '225', stayNights: 1, isReturningGuest: false },
  ...
  'group-departures': [
    { guestId: 'guest-diana', reservationId: 'res-diana-mar', segment: 'departing', loyaltyTier: 'non-member', rateCode: 'BAR', room: '303', stayNights: 2, isReturningGuest: false },
    ...
    { guestId: 'guest-marco', reservationId: 'res-marco-mar', segment: 'departing', loyaltyTier: 'club-member', rateCode: 'RACK', room: '112', stayNights: 1, isReturningGuest: true },
    { guestId: 'guest-kwame', reservationId: 'res-kwame-mar', segment: 'departing', loyaltyTier: 'non-member', rateCode: 'CORP', groupCode: 'GROUP2026', room: '201', stayNights: 4, isReturningGuest: false },
    { guestId: 'guest-carmen', reservationId: 'res-carmen-mar', segment: 'departing', loyaltyTier: 'club-member', rateCode: 'CORP', room: '309', stayNights: 2, isReturningGuest: true },
    { guestId: 'guest-rafael', reservationId: 'res-rafael-mar', segment: 'checked-out', loyaltyTier: 'non-member', rateCode: 'BAR', room: '412', stayNights: 1, isReturningGuest: false },
    { guestId: 'guest-javier', reservationId: 'res-javier-mar', segment: 'departing', loyaltyTier: 'non-member', rateCode: 'AAA', room: '316', stayNights: 3, isReturningGuest: false },
    { guestId: 'guest-kenji', reservationId: 'res-kenji-mar', segment: 'checked-out', loyaltyTier: 'non-member', rateCode: 'RACK', room: '408', stayNights: 1, isReturningGuest: false },
    { guestId: 'guest-raj', reservationId: 'res-raj-mar', segment: 'departing', loyaltyTier: 'non-member', rateCode: 'RACK', groupCode: 'GROUP2026', room: '507', stayNights: 2, isReturningGuest: false },
    { guestId: 'guest-nook', reservationId: 'res-nook-mar', segment: 'departing', loyaltyTier: 'non-member', rateCode: 'CORP', groupCode: 'GROUP2026', room: '208', stayNights: 4, isReturningGuest: true },
    { guestId: 'guest-anya', reservationId: 'res-anya-mar', segment: 'departing', loyaltyTier: 'silver-elite', rateCode: 'BAR', groupCode: 'GRP1027', room: '217', stayNights: 3, isReturningGuest: true },
    { guestId: 'guest-sophie-t', reservationId: 'res-sophie-t-mar', segment: 'departing', loyaltyTier: 'non-member', rateCode: 'RACK', room: '115', stayNights: 1, isReturningGuest: false },
    { guestId: 'guest-ines', reservationId: 'res-ines-mar', segment: 'departing', loyaltyTier: 'silver-elite', rateCode: 'AAA', room: '309', stayNights: 2, isReturningGuest: false },
    { guestId: 'guest-leila', reservationId: 'res-leila-mar', segment: 'departing', loyaltyTier: 'gold-elite', rateCode: 'CORP', room: '411', stayNights: 3, isReturningGuest: true },
    { guestId: 'guest-lucas', reservationId: 'res-lucas-mar', segment: 'departing', loyaltyTier: 'non-member', rateCode: 'BAR', room: '118', stayNights: 1, isReturningGuest: false },
