...
export const builtInGroupGuests: Record<string, BroadcastGuestEntry[]> = {
  'group-arrivals': [
    ...
    { guestId: 'guest-carlos', reservationId: 'res-carlos-mar', segment: 'expecting', loyaltyTier: 'non-member', rateCode: 'BAR', room: '127' },
    { guestId: 'guest-david-w', reservationId: 'res-david-w-mar', segment: 'expecting', loyaltyTier: 'non-member', rateCode: 'CORP', groupCode: 'CONF2026', room: '305' },
    { guestId: 'guest-nina', reservationId: 'res-nina-mar', segment: 'expecting', loyaltyTier: 'non-member', rateCode: 'CORP', room: '403' },
    { guestId: 'guest-grace', reservationId: 'res-grace-mar', segment: 'expecting', loyaltyTier: 'non-member', rateCode: 'AAA', room: '210' },
    { guestId: 'guest-mei', reservationId: 'res-mei-mar', segment: 'expecting', loyaltyTier: 'club-member', rateCode: 'CORP', groupCode: 'GROUP2026', room: '229' },
    { guestId: 'guest-tariq', reservationId: 'res-tariq-mar', segment: 'expecting', loyaltyTier: 'non-member', rateCode: 'RACK', room: '411' },
    { guestId: 'guest-elena', reservationId: 'res-elena-mar', segment: 'expecting', loyaltyTier: 'silver-elite', rateCode: 'BAR', room: '320' },
  ...
  'group-in-house': [
    ...
    { guestId: 'guest-priya', reservationId: 'res-priya-mar', loyaltyTier: 'non-member', rateCode: 'CORP', groupCode: 'CONF2026', room: '419' },
    { guestId: 'guest-yuki', reservationId: 'res-yuki-mar', loyaltyTier: 'non-member', rateCode: 'BAR', room: '511' },
    { guestId: 'guest-fatima', reservationId: 'res-fatima-mar', loyaltyTier: 'diamond-elite', rateCode: 'CORP', room: '602' },
    { guestId: 'guest-lucia', reservationId: 'res-lucia-mar', loyaltyTier: 'non-member', rateCode: 'AAA', room: '226' },
    { guestId: 'guest-ahmed', reservationId: 'res-ahmed-mar', loyaltyTier: 'non-member', rateCode: 'RACK', groupCode: 'GROUP2026', room: '117' },
    { guestId: 'guest-hiroshi', reservationId: 'res-hiroshi-mar', loyaltyTier: 'gold-elite', rateCode: 'CORP', room: '504' },
    { guestId: 'guest-sven', reservationId: 'res-sven-mar', loyaltyTier: 'non-member', rateCode: 'GOV', room: '233' },
    { guestId: 'guest-anya', reservationId: 'res-anya-mar', loyaltyTier: 'non-member', rateCode: 'BAR', groupCode: 'GRP1027', room: '340' },
    { guestId: 'guest-sophie-t', reservationId: 'res-sophie-t-mar', loyaltyTier: 'non-member', rateCode: 'RACK', room: '128' },
    { guestId: 'guest-victor', reservationId: 'res-victor-mar', loyaltyTier: 'platinum-elite', rateCode: 'CORP', groupCode: 'CONF2026', room: '601' },
    { guestId: 'guest-ines', reservationId: 'res-ines-mar', loyaltyTier: 'silver-elite', rateCode: 'AAA', room: '309' },
    { guestId: 'guest-leila', reservationId: 'res-leila-mar', loyaltyTier: 'gold-elite', rateCode: 'CORP', room: '425' },
    { guestId: 'guest-lucas', reservationId: 'res-lucas-mar', loyaltyTier: 'non-member', rateCode: 'BAR', room: '115' },
  ...
  'group-departures': [
    ...
    { guestId: 'guest-kwame', reservationId: 'res-kwame-mar', segment: 'departing', loyaltyTier: 'non-member', rateCode: 'CORP', groupCode: 'GROUP2026', room: '420' },
    { guestId: 'guest-carmen', reservationId: 'res-carmen-mar', segment: 'departing', loyaltyTier: 'platinum-elite', rateCode: 'CORP', room: '501' },
    { guestId: 'guest-rafael', reservationId: 'res-rafael-mar', segment: 'checked-out', loyaltyTier: 'non-member', rateCode: 'BAR', room: '209' },
    { guestId: 'guest-javier', reservationId: 'res-javier-mar', segment: 'departing', loyaltyTier: 'non-member', rateCode: 'AAA', room: '316' },
    { guestId: 'guest-kenji', reservationId: 'res-kenji-mar', segment: 'checked-out', loyaltyTier: 'club-member', rateCode: 'RACK', room: '408' },
  ],
};
