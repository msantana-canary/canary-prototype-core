...
export const mockThreads: Thread[] = [
  ...
  // New guest threads
  {
    ...
    lastMessageAt: new Date('2024-11-19T09:15:00'),
    isUnread: true,
    status: 'inbox',
  },
  {
    ...
    lastMessageAt: new Date('2024-11-19T08:50:00'),
    isUnread: true,
    status: 'inbox',
  },
  {
    ...
    lastMessageAt: new Date('2024-11-19T10:00:00'),
    isUnread: false,
    status: 'inbox',
  },
  {
    ...
    lastMessageAt: new Date('2024-11-19T07:30:00'),
    isUnread: true,
    status: 'inbox',
  },
  {
    ...
    lastMessageAt: new Date('2024-11-18T23:45:00'),
    isUnread: false,
    status: 'inbox',
  },
  {
    ...
    lastMessageAt: new Date('2024-11-18T16:20:00'),
    isUnread: false,
    status: 'inbox',
  },
  {
    ...
    lastMessageAt: new Date('2024-11-19T08:00:00'),
    isUnread: true,
    status: 'inbox',
  },
  {
    ...
    lastMessageAt: new Date('2024-11-18T15:30:00'),
    isUnread: false,
    status: 'inbox',
  },
  {
    ...
    lastMessageAt: new Date('2024-11-19T09:00:00'),
    isUnread: true,
    status: 'inbox',
  },
  {
    ...
    lastMessageAt: new Date('2024-11-18T22:10:00'),
    isUnread: false,
    status: 'inbox',
  },
  {
    ...
    lastMessageAt: new Date('2024-11-19T10:30:00'),
    isUnread: false,
    status: 'inbox',
  },
...
export const mockMessages: Record<string, Message[]> = {
  ...
  '18': [
    {
      ...
      timestamp: new Date('2024-11-19T08:50:00'),
      channel: 'SMS',
      status: 'delivered',
    },
  ],
  ...
  '19': [
    {
      ...
      timestamp: new Date('2024-11-19T09:40:00'),
      channel: 'SMS',
      status: 'delivered',
    },
    {
      ...
      timestamp: new Date('2024-11-19T09:42:00'),
      channel: 'SMS',
      status: 'delivered',
    },
    {
  ...
  '20': [
    {
      ...
      timestamp: new Date('2024-11-19T07:30:00'),
      channel: 'SMS',
      status: 'delivered',
    },
  ],
  ...
  '21': [
    {
      ...
      timestamp: new Date('2024-11-18T23:45:00'),
      channel: 'SMS',
      status: 'delivered',
    },
    {
      ...
      timestamp: new Date('2024-11-18T23:46:00'),
      channel: 'SMS',
      status: 'delivered',
    },
  ],
  ...
  '22': [
    ...
    },
    {
      ...
      timestamp: new Date('2024-11-18T16:05:00'),
      channel: 'SMS',
      status: 'delivered',
    },
    {
      ...
      timestamp: new Date('2024-11-18T16:20:00'),
      channel: 'SMS',
      status: 'delivered',
    },
  ],
  ...
  '24': [
    ...
    },
    {
      ...
      timestamp: new Date('2024-11-18T15:02:00'),
      channel: 'SMS',
      status: 'delivered',
    },
    {
  ...
  '26': [
    {
      ...
      timestamp: new Date('2024-11-18T21:30:00'),
      channel: 'SMS',
      status: 'delivered',
    },
    {
      ...
      timestamp: new Date('2024-11-18T21:35:00'),
      channel: 'SMS',
      status: 'delivered',
    },
    {
      ...
      timestamp: new Date('2024-11-18T22:10:00'),
      channel: 'SMS',
      status: 'delivered',
    },
  ],
